...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OutPutConfig_t, stringdata0) + ofs \
...
static const uint qt_meta_data_OutPutConfig[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Char, QMetaType::SChar,    6,
...
void OutPutConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { char _r = _t->back_translate((*reinterpret_cast< signed char(*)>(_a[1])));
...
void *OutPutConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OutPutConfig.stringdata0))
