    ...
    ui(new Ui::Page_1)
{
    ...
    ui->stopButton->setText(QString::fromUtf8("\u505c\u6b62"));
    ...
    speedWatch->type=QString::fromUtf8("\u8F6C\u901F");//转速
    torsionWatch->type=QString::fromUtf8("\u8F6C\u77E9");//转矩
    powerWatch->type=QString::fromUtf8("\u529F\u7387");//功率
    powerWatch->unit="Kw";
