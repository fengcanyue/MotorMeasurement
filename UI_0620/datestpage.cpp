...
{
    test_torsionlist.append(arg1);
    test_speedlist.append(arg2);
    repaint();
}
...
void DATestPage::mousePressEvent(QMouseEvent *event)
{
...
void DATestPage::mouseReleaseEvent(QMouseEvent *event)
{
