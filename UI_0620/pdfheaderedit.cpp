...
void pdfHeaderEdit::on_exportButton_clicked()
{
    ...
    printer.setOutputFileName("/mnt/"+QDateTime::currentDateTime().toString("MMdd-hh-mm-ss")+"picture.pdf");
...
void pdfHeaderEdit::exportDataChart()
{
    QPrinter printer;
    printer.setOutputFormat(QPrinter::PdfFormat);
    printer.setOutputFileName("/mnt/"+QDateTime::currentDateTime().toString("MMdd-hh-mm-ss")+"data.pdf");
    printer.setPageSize(QPrinter::A4);
    QPainter painter;
    painter.begin(&printer);
...
bool pdfHeaderEdit::exportDAtestChart(QPixmap p)
{
    QPrinter printer;
    printer.setOutputFormat(QPrinter::PdfFormat);
    printer.setOutputFileName("/mnt/"+QDateTime::currentDateTime().toString("MMdd-hh-mm-ss")+"datest.pdf");
    //printer.setOutputFileName("/home/wly/"+QDateTime::currentDateTime().toString("MMdd-hh-mm-ss")+"datest.pdf");
    printer.setPageSize(QPrinter::A4);
    QPainter painter;
    painter.begin(&printer);
    QFont titlefont(QString::fromUtf8("\u9ed1\u4f53"),20);
...
void pdfHeaderEdit::mousePressEvent(QMouseEvent *event)
{
...
void pdfHeaderEdit::mouseReleaseEvent(QMouseEvent *event)
{
